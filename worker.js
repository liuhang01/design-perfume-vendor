...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === '/api/debug-auth' && request.method === 'GET') return json({ hasPassword: Boolean(env.ADMIN_PASSWORD), username: env.ADMIN_USERNAME || null, hasSessionSecret: Boolean(env.SESSION_SECRET) });
